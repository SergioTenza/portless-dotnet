...
public class DaemonInstallCommandTests
{
    ...
    [Fact]
    public async Task ExecuteAsync_DefaultSettings_InstallsWithoutHttpsOrEnable()
    {
    ...
    [Fact]
    public async Task ExecuteAsync_WithHttps_InstallsWithHttps()
    {
    ...
    [Fact]
    public async Task ExecuteAsync_WithEnable_InstallsWithEnable()
    {
        ...
        Assert.Equal(0, result);
        _daemonServiceMock.Verify(x => x.InstallAsync(false, true), Times.Once);
    }

    [Fact]
    public async Task ExecuteAsync_WithHttpsAndEnable_InstallsWithBoth()
    {
    ...
    public async Task ExecuteAsync_ServiceThrowsException_Returns1()
    {
        _daemonServiceMock.Setup(x => x.InstallAsync(It.IsAny<bool>(), It.IsAny<bool>()))
            .ThrowsAsync(new InvalidOperationException("systemctl not found"));
    ...
    [Fact]
    public async Task ExecuteAsync_ServiceThrowsGenericException_Returns1()
    {
        _daemonServiceMock.Setup(x => x.InstallAsync(It.IsAny<bool>(), It.IsAny<bool>()))
